...
const BulkRegistrationComponent = (props: IBulkRegistrationProps) => {
  ...
  return (
    <div className="container">
      <form className="form-horizontal">
        <h2>
          <small>Bulk Associate Registration</small>
        </h2>
        <hr />
        <div className="form-group">
          ...
          <div className="col-md-5">
            <input
              ...
              name="registration"
              accept=".xlsx,.xls"
              ref={(ref: HTMLInputElement) => (file.fileInput = ref)}
        ...
        <div className="form-group">
          <label
            htmlFor="transportDropPoint"
            className="col-md-5 control-label"
          />
          <button
            disabled={!props.fileParameter || !props.fileParameter.data}
            type="button"
            className="btn"
            onClick={() => onUpload()}
          >
...
export default BulkRegistrationComponent;
